...
core.register_alias("stairs:stair_asphalt","streets:stair_asphalt")

-- Hotfix #2; June 27, 2014; https://github.com/webdesigner97/streets/issues/25
core.register_alias("streets:asphalt_stair","streets:stair_asphalt")
core.register_alias("streets:asphalt_slab","streets:slab_asphalt")